...
**None.** Klicky does not collect, store, or transmit any personal information.
...
- **App settings** — your preferences for the last inning warning and keep-screen-awake toggle

This data is only used to run the app. It is not backed up to any external server, and we have no access to it.

---

## Third Parties

Klicky does not use any third-party analytics, advertising, crash reporting, or tracking SDKs. No data is shared with any third party.

---

## Children

Klicky does not knowingly collect data from anyone, including children under 13.
...
Questions about this policy? Email: jasonblett@gmail.com
